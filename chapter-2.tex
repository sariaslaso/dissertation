...
energy~(\ref{eq:HF_energy}).
% LINK THE MATRIX ELEMENTS WITH THE ORBITAL ENERGIES OBTAINED BY
...
approach introduces a representation of the molecular orbitals by
