...
the orbital exponent $\zeta$ satisfies $\zeta \epsilon \Re > 0 $. The
...
form~(\ref{eq:f_STO}). The orbital exponents $\zeta$'s involved in
each basis set were obtained by an optimization process closely
...
of $(n,l,m)$ values indicate the size of the basis set implemented for
a given molecule.
