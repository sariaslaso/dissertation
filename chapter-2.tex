...
the molecular orbital $\varphi_{i}$ introduced in Roothaan's
...
converged numerical results including the geomatrical parameters of
the equilibrium configuration for the ground state of H$_{2}$O.
