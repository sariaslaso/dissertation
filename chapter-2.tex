...
complicated forms of wave functions. % mention that our calculations
                                     % use as a reference the
                                     % one-centre scf results obtained
                                     % by moccia, given that we use a
                                     % one-centre orbital dependent
                                     % effective potential
