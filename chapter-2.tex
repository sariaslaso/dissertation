...
combination of Slater-type orbitals (\textsc{sto}s), equivalent to the
Roothaan expansion~(\ref{eq:lcao_roothaan}), with basis functions of
the form
%
\begin{eqnarray}
  \begin{split}
...
molecule~\cite{Moccia_JCP_2164,Moccia_1964}. The expansion
coefficients $c_{si}$ in Eq.~(\ref{eq:lcao_roothaan}) are evaluated
within the same iterative process in order to minimize the electronic
energy.
