...
analytical functions represented a crucial development in obtaining
...
orbitals are expressed by a linear combination of atomic orbitals,
%
\begin{eqnarray}
  \begin{split}
    \varphi_{i} & = \sum\limits_{s} c_{si} \chi_{s}
  \end{split}
