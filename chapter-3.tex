...
Strategies used to obtain the optimal value of $\eta$ involve a
Pad\'{e}-approximation-extrapolation
procedure~\cite{Moiseyev_Pade_2005}, and minimizing first and
second-order terms in the Taylor expansion of these
trajectories~\cite{RissMeyer_1993}. Such correction schemes have
proven to yield accurate results for diatomic molecules with a
\textsc{cap}.
% add references cited in the partial wave write-up
