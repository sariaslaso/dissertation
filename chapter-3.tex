...
of complex eigenvalues which form complex trajectories, $E(\eta)$. The
\textsc{cap} strength $\eta$ is varied in order to find an optimal
finite value of $\eta$ such that it makes the resonance stable. % explain what does this mean
The ultimate goal is to remove the perturbation introduced by the
\textsc{cap}.
