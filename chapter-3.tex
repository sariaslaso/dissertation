...
A \textsc{cap} is introduced as an artificial imaginary potential
which acts as a perturbation to the Hamiltonian. This artifact allows
an analytical continuation of the Hamiltonian to the complex plane,
where it acts as an effective potential that suppresses the diverging
tail of the resonance wave function in the vicinity of the edges of a
numerical grid. As a result, the solutions of the modified
non-Hermitian Hamiltonian behave as square-integrable eigenstates
...
the strength of the \textsc{cap}, and the function $W(r)$ is most
commonly defined as a quadratic potential centred at some radius
$r_{\mathrm{c}}$. Several methods have been tested that study the
convergence of the resonance energies as the \textsc{cap} strength
weakens, i.e., as $\eta \to 0$.
