...
The study of atomic and molecular strong-field ionization events along
with the quantitative modelling of the associated ionization rates
have been successfully approached within the framework of
non-Hermitian quantum mechanics. A time-independent interpretation of
these ionization processes becomes possible by the implementation of
analytic continuation methods on the Hamiltonian. Such extensions lead
to complex eigenvalues of the form
%
\begin{eqnarray}
