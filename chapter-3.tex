...
As an illustrative example, the trajectory of eigenvalues as a
...
-0.1\ \mathrm{a.u.}$.
%mention range of \eta values shown
...
\begin{figure}
  ...
  \caption{Trajectory of complex eigenvalues as a function of $\eta$
    (blue circles) corresponding to an $l_{\mathrm{max}}=3$
    calculation of the $3a_{1}$ \textsc{mo}. The energy corresponding
    to the $\eta$ stabilization value is shown with a red cross. The
    first and second order Riss-Meyer corrected energies are indicated
    as green and magenta crosses, respectively. The electric field
    strength is $-0.1\ \mathrm{a.u.}$}
