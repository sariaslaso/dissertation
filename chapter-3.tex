...
$3a_{1}$ orbital. Section~\ref{ch:partial_wave} is concerned with the
...
are contrasted with a previous calculation that includes the model
potential and Gaussian-type basis~\cite{illescas_2015}.
