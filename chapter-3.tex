...
energy agree with Hartree-Fock results. The \textsc{opm} values quoted
in Fig.~\ref{fig:energies_fieldfree} are an interesting comparison
point since they result from an effective self-consistent potential.
