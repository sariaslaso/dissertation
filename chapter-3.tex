...
eigenvalues obtained on the $\eta-$grid, and $\tilde{\eta}$ is an
optimal value for the \textsc{cap} strength given by the condition
%
\begin{eqnarray}
  \begin{split}
...
\textsc{cap} strengths in steps of $10^{-3}\ \mathrm{a.u.}$.
