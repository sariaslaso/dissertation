...
as indicated in Eq.~(\ref{eq:complex_eigenE}). A quadratic complex
absorbing potential~(\textsc{cap}) of the form~(\ref{eq:VCAP}) is
applied to the system of coupled differential equations in order to
