...
\textsc{scf} effective potential to include a polar angle, $\theta$,
dependence for the $3a_{1}$ orbital, as opposed to the $1b_{1}$ and
$1b_{2}$ orbitals. However, the inclusion of the dependence in this
effective potential on the azimuthal angle $\phi$ seems crucial in
order to reproduce the behaviour observed for the dc Stark shift.
