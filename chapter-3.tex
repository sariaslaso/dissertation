...
of radial equations of the form
%
\begin{eqnarray}
  \begin{split}
...
\end{eqnarray}
%
in which the matrix elements $R_{l,m}^{l',m'}(r)$ are evaluated by
means of Gaunt integrals.


Once a partial-wave potential has been generated for each hydrogen
atom one can proceed to find the eigenvalues for the field-free
problem
