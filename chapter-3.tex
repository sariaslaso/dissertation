...
state via $\Gamma\tau=1$, exhibit a threshold behavior at the weaker
...
The results are summarized in Table~\ref{tab:3a1_results} for further
reference, to allow comparison with future calculations.
