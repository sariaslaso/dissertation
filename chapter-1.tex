...
formulation of quantum mechanics. Ionization of the H$_{2}$O molecule,
which is of interest in the current work, has been attacked by
implementing weak-field asymptotic theory~\cite{Toru_weakF_H2O}
~[\textcolor{red}{ELABORATE}]. A alternative comes from the use of
complex basis functions to solve the many body Schr\"{o}dinger
