...
such as above threshold ionization~(\textsc{ati}), which reveals that
an atom may absorb many more photons than the minimum necessary for
...
The Keldysh theory of strong-field approximation is one of the
