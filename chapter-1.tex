...
background of the Hartree-Fock formulation that sets the basis of a
self-consistent field formulation of the H$_{2}$O molecular
orbitals. Chapter~\ref{ch:dc_h2o} contains the investigation of the
...
approached in Chapters~\ref{cha:ati} and~\ref{cha:sp_approx}.
